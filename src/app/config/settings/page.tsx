      ...
      <div className="grid gap-6">
        <section className="p-8 rounded-3xl glass border border-border/50 shadow-2xl space-y-8 relative overflow-hidden group">
          ...
          <div className="relative">
            ...
            <p className="text-muted-foreground text-sm max-w-lg leading-relaxed font-medium">
              Sincroniza tus datos entre dispositivos exportando un archivo de respaldo. PayControl es local-first:
              tus datos viven en tu navegador, no en la nube.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative">
            ...
            >
              <div className="text-left">
                <p className="font-black text-primary group-hover/btn:translate-x-1 transition-transform tracking-tight">
                  EXPORTAR RESPALDO
                </p>
                <p className="text-[11px] text-muted-foreground font-bold mt-1 uppercase tracking-widest">
                  Descarga un .json con toda tu info
                </p>
              </div>
            ...
            >
              <div className="text-left">
                <p className="font-black text-foreground group-hover/btn:translate-x-1 transition-transform tracking-tight">
                  IMPORTAR ARCHIVO
                </p>
                <p className="text-[11px] text-muted-foreground font-bold mt-1 uppercase tracking-widest">
                  Desde archivo .json
        ...
        <section className="p-8 rounded-3xl bg-destructive/5 border border-destructive/20 shadow-xl space-y-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-2 font-medium">Estas acciones son permanentes y no se pueden deshacer.</p>
          </div>
